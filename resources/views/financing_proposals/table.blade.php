        ...
        @foreach($financingProposals as $financingProposal)
            ...
            <td>{{ $financingProposal->proposal_id }}</td>
                <td width="120">
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('financingProposals.show', [$financingProposal->id]) }}" class='btn btn-default btn-xs'>
                            <i class="far fa-eye"></i>
                        </a>
                        <a href="{{ route('financingProposals.edit', [$financingProposal->id]) }}" class='btn btn-default btn-xs'>
