...
<h1 style="text-align: center; font-size: 20px; font-weight: bold; text-decoration: underline;">Notificação de negócio aprovado</h1>
...
@component('mail::table')
  <table style="border-collapse: collapse;">
    ...
    <tr style="border-bottom: 1px solid rgba(112, 112, 112, 21%); display: flex; justify-content: space-between;">
        ...
        <td style="padding: 10px;"><b>@percentage($proposal->finalBusinessStudy->total_discount_perc)</b></td>
    </tr>
    <tr style="border-bottom: 1px solid rgba(112, 112, 112, 21%); display: flex; justify-content: space-between;">
...
@component('mail::table')
  <table style="border-collapse: collapse;">
    ...
    @if ($proposal->car->condition_id == 1)
        <tr style="border-bottom: 1px solid rgba(112, 112, 112, 21%); display: flex; justify-content: space-between;">
            <td style="padding: 10px;"><b>Percentagem:</b></td>
            <td style="padding: 10px;"><b>@percentage($proposal->initialBusinessStudy->total_discount_perc)</b></td>
        </tr>
        <tr style="border-bottom: 1px solid rgba(112, 112, 112, 21%); display: flex; justify-content: space-between;">
            <td style="padding: 10px;"><b>Desconto:</b></td>
