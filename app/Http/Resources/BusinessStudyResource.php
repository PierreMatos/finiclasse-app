    ...
    public function toArray($request)
    {
        return [
            ...
            'business_study_authorization' => [
                ...
                'name' => $this->business_study_authorization->name,
                'min' => $this->business_study_authorization->min,
                'max' => $this->business_study_authorization->max,
                'responsible_id' => $this->business_study_authorization->responsible_id,
                'color' => $this->business_study_authorization->color,
            ],
            'tradein_id' => $this->tradein_id,
