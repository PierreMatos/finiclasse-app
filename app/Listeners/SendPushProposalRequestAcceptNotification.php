...
use App\Notifications\ProposalRequestAcceptNotification;

class SendPushProposalRequestAcceptNotification
{
    /**
     ...
     * @return void
     */
    public function handle(PushProposalRequestAccept $event)
    {
        ...
        Notification::send($vendorsNotification, new ProposalRequestAcceptNotification($event->proposal));
        //
    }
}
