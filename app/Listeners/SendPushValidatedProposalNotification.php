...
class SendPushValidatedProposalNotification
{
    ...
    public function handle(PushValidatedProposal $event)
    {
        ...
        $vendors = User::where([['device_key', '!=', null]])->where('id', '=', $event->proposal->vendor[0]->id)->pluck('device_key')->all();
        ...
        //Notification
        $vendorsNotification = User::where('id', '=', $event->proposal->vendor[0]->id)->get();
