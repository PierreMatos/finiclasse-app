...
use App\Notifications\ProposalRequestDenyNotification;

class SendPushProposalRequestDenyNotification
{
    /**
     ...
     * @return void
     */
    public function handle(PushProposalRequestDeny $event)
    {
        ...
        Notification::send($vendorsNotification, new ProposalRequestDenyNotification($event->proposal));
        //
    }
}
