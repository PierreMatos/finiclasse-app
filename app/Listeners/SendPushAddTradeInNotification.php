...
class SendPushAddTradeInNotification
{
    ...
    public function handle(PushAddTradeIn $event)
    {
        ...
        $adminsAndDirectorsAndChefeByStand = User::where([['device_key', '!=', null]])
            ...
            // ->where('stand_id', $event->car->proposalTradeIn->vendor->stand_id)
        ...
        $data = [
            ...
            "notification" => [
                ...
                "body" => 'Vendedor XXX solicitou a validação de retoma na proposta nº ' . $event->car->proposal()->vendor->name,
            ]
        ];
